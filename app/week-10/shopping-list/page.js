...
export default function Page(){
    ...
    async function handleAddItem(newItem) {
        try {
            ...
            setItemsArray((prevItems) => [...(prevItems || []), itemWithId]);
        } catch (error) {
    ...
    return(
        <main>
            ...
            <>
                ...
                <Link href="/week-10/" className="text-lg bg-blue-500 text-white rounded px-2 py-1 mt-4 hover:bg-blue-600 cursor-pointer" >Click here to return to the login page</Link>
